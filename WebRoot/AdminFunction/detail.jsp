...
<html>
  <head>
	...
	<meta name="viewport" content="width=device-width,initial-scale=0.3">
  	...
  	<script type="text/javascript" src="JS/gridview1.js"></script>
  </head>
  
  <body>
  <h2 align="center">支出明細</h2>
  <table   width="1%" align="left">
  <tr><td><s:include value="/MEMU/memu.jsp"></s:include></td></tr>
  
  </table>
   <div class="filtering"><s:select list="validDate" name="selectDate" ></s:select><s:submit id="search" theme="simple" key="查詢"></s:submit></div>
